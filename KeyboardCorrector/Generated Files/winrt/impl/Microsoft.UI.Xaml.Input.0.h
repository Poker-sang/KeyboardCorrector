...
namespace winrt::impl
{
    ...
    struct consume_Microsoft_UI_Xaml_Input_IPointerRoutedEventArgs
    {
        ...
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Input::PointerPoint) GetCurrentPoint(winrt::Microsoft::UI::Xaml::UIElement const& relativeTo) const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IVector<winrt::Microsoft::UI::Input::PointerPoint>) GetIntermediatePoints(winrt::Microsoft::UI::Xaml::UIElement const& relativeTo) const;
    };
