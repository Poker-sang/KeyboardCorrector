...
namespace winrt::impl
{
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(int32_t) Rank() const;
        WINRT_IMPL_AUTO(void) Rank(int32_t value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(bool) PrependIfRankCollision() const;
        WINRT_IMPL_AUTO(void) PrependIfRankCollision(bool value) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Windows::ApplicationModel::DynamicDependency::PackageDependencyProcessorArchitectures) Architectures() const;
        WINRT_IMPL_AUTO(void) Architectures(winrt::Microsoft::Windows::ApplicationModel::DynamicDependency::PackageDependencyProcessorArchitectures const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(bool) VerifyDependencyResolution() const;
        WINRT_IMPL_AUTO(void) VerifyDependencyResolution(bool value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Windows::ApplicationModel::DynamicDependency::PackageDependencyLifetimeArtifactKind) LifetimeArtifactKind() const;
        WINRT_IMPL_AUTO(void) LifetimeArtifactKind(winrt::Microsoft::Windows::ApplicationModel::DynamicDependency::PackageDependencyLifetimeArtifactKind const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) LifetimeArtifact() const;
        WINRT_IMPL_AUTO(void) LifetimeArtifact(param::hstring const& value) const;
    };
    ...
    struct consume_Microsoft_Windows_ApplicationModel_DynamicDependency_IPackageDependency
    {
        ...
        WINRT_IMPL_AUTO(winrt::Microsoft::Windows::ApplicationModel::DynamicDependency::PackageDependencyContext) Add() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Windows::ApplicationModel::DynamicDependency::PackageDependencyContext) Add(winrt::Microsoft::Windows::ApplicationModel::DynamicDependency::AddPackageDependencyOptions const& options) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Windows::ApplicationModel::DynamicDependency::PackageDependencyContextId) ContextId() const;
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::Windows::ApplicationModel::DynamicDependency::PackageDependencyContext) CreateInstance(winrt::Microsoft::Windows::ApplicationModel::DynamicDependency::PackageDependencyContextId const& contextId) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(int32_t) Default() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::Windows::ApplicationModel::DynamicDependency::PackageDependency) GetFromId(param::hstring const& id) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Windows::ApplicationModel::DynamicDependency::PackageDependency) GetFromIdForSystem(param::hstring const& id) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Windows::ApplicationModel::DynamicDependency::PackageDependency) Create(param::hstring const& packageFamilyName, winrt::Windows::ApplicationModel::PackageVersion const& minVersion) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Windows::ApplicationModel::DynamicDependency::PackageDependency) Create(param::hstring const& packageFamilyName, winrt::Windows::ApplicationModel::PackageVersion const& minVersion, winrt::Microsoft::Windows::ApplicationModel::DynamicDependency::CreatePackageDependencyOptions const& options) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::Windows::ApplicationModel::DynamicDependency::PackageDependency) CreateForSystem(param::hstring const& packageFamilyName, winrt::Windows::ApplicationModel::PackageVersion const& minVersion, winrt::Microsoft::Windows::ApplicationModel::DynamicDependency::CreatePackageDependencyOptions const& options) const;
        [[nodiscard]] WINRT_IMPL_AUTO(uint32_t) GenerationId() const;
    };
