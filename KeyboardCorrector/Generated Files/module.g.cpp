...
void* winrt_make_KeyboardCorrector_MainWindow();
...
void* __stdcall winrt_get_activation_factory([[maybe_unused]] std::wstring_view const& name)
{
    ...
    if (requal(name, L"KeyboardCorrector.MainWindow"))
    {
        return winrt_make_KeyboardCorrector_MainWindow();
    }

    if (requal(name, L"KeyboardCorrector.XamlMetaDataProvider"))
    {
        return winrt_make_KeyboardCorrector_XamlMetaDataProvider();
    }
